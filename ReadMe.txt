...
2. Search for 'BuddyPress Shortcodes'
3. Activate 'BuddyPress Shortcodes' from your Plugins page.

= From WordPress.org =

1. Download BuddyPress Shortcodes.
2. Upload the 'buddypress-shortcodes' directory to your '/wp-content/plugins/' directory, using your favorite method (ftp, sftp, scp, etc...)
3. Activate 'BuddyPress Shortcodes' from your Plugins page. 

== Frequently Asked Questions ==

= Where can I find the tutorials? =
You can find them <a href="http://wordpress.webimetry.com/plugins/buddypress-shortcodes/">here</a>

== Screenshots ==
1. BuddyPress Shortcodes Button
2. Modal Window to build Shortcodes
